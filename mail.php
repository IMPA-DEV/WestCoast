...
// данные с мыла
    ...
    $size_of_move = trim($_POST["size"]);
    $code_from = trim($_POST["zip"]);
...
<head>
  ...
  <title>LEAD FROM West Coast</title>
  <style>
...
';
    ...
    $headers .= "From: West Coast <admin@west-coastmoving.com>\r\n";
    if($phone!=''||$email!='') {
